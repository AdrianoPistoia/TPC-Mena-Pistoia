...
namespace Negocio
{
    class Diccionario
    {
        ...
        public static string LISTAR_TODOS_ARTICULOS =   "select P.Id, P.Codigo, P.Nombre, P.Descripcion, M.Descripcion as Marca, P.IdMarca, C.Descripcion as Categoria, P.IdCategoria, P.IdImagen, I.Descripcion as ImDesc, I.Link as Link,  P.Precio, P.Cantidad " +
